...
// yet both mean there's no natural list to page through.
...
export function stepGameList(table, getGameList, currentGame, dir) {
  if (!table || currentGame?.standalone) return null;
  const list = getGameList();
