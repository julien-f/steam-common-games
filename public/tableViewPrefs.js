...
export function restoreTableView(table, prefKey, paramName) {
...
export function bindViewPersistence(table, prefKey) {
...
export function shareTableView(table, paramName, btn) {
  const params = new URLSearchParams(location.search);
...
export function resetTableView(table, prefKey, paramName) {
  table.setViewState({});
  setPref(prefKey, {});
  const params = new URLSearchParams(location.search);
  params.delete(paramName);
