...
//
// Route order matters: /lists/owned, /lists/wishlist, /lists/compare, /lists/shared and
// /lists/bundle/:bundleId are registered before the generic /lists/:listId — @solidjs/router
// ranks routes by segment specificity (a
