...
// pages.
import { initNav, type NavPageKey } from './nav.tsx';
import { initLightbox } from './lightbox.tsx';
import { initPanel } from './panel.tsx';
...
// signatures (Parameters<typeof ...>) so this stays in sync automatically if either's options
// grow.
