...
- Side panel: hero image area becomes a carousel — banner first, then screenshots; prev/next overlay buttons (visible on hover) and dot indicators; clicking a screenshot slide opens the fullscreen lightbox with keyboard arrow navigation
