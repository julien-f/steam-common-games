...
const { LIBRARY_CACHE_TTL_MS, RESOLVE_CACHE_TTL_MS, RATING_CACHE_TTL_MS, META_CACHE_TTL_MS, SEARCH_CACHE_TTL_MS, NEWS_CACHE_TTL_MS } = require('./config');
...
const GROUPS = [
  ...
  { table: 'cache_meta',    ttl: META_CACHE_TTL_MS,     prefixes: ['hltb:', 'meta:', 'browse:', 'tagnames:', 'protondb:', 'schema:', 'achrarity:'] },
  { table: 'cache_search',  ttl: SEARCH_CACHE_TTL_MS,   prefixes: ['search:'] },
  { table: 'cache_news',    ttl: NEWS_CACHE_TTL_MS,     prefixes: ['news:'] },
];
...
// expected to setCache() a fresh value right after, which overwrites it anyway.
