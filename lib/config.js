...
// How long a Steam login session lasts before its cookie stops being honoured (lib/auth.js).
const SESSION_TTL_MS = Number(process.env.SESSION_TTL_DAYS) * 24 * 60 * 60 * 1000;

module.exports = { LIBRARY_CACHE_TTL_MS, RESOLVE_CACHE_TTL_MS, RATING_CACHE_TTL_MS, META_CACHE_TTL_MS, SEARCH_CACHE_TTL_MS, NEWS_CACHE_TTL_MS, BUNDLES_CACHE_TTL_MS, ITAD_ID_CACHE_TTL_MS, MISS_CACHE_TTL_MS, RESOLVE_MISS_CACHE_TTL_MS, OUTBOUND_HOURLY_MAX, OUTBOUND_DAILY_MAX, SESSION_TTL_MS };
